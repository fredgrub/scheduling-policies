...
def get_exec_command(configs, policy_flag, number_of_tasks):
    ...
    cmd = "./" + simulator + " " + "xmls/plat_day.xml" + " "\
...
def perform_experiments(num_exp, trace, trace_name, policies, conditions):
    ...
    for exp in range(num_exp):
        ...
        print(f"Performing scheduling experiment {exp + 1}. Number of tasks={number_of_tasks}")
...
def workload_experiments():
    ...
    traces = {
        ...
        # "CTC_SP2": [22, "swfs/CTC-SP2-1996-3.1-cln.swf", "xmls/deployment_ctcsp2.xml"],
        # "HPC2N": [83, "swfs/HPC2N-2002-2.2-cln.swf", "xmls/deployment_hpc2n.xml"],
...
def main():
    ...
    # "SAF": "-saf"
    #
    # == Possible traces (full path is swfs/<*.swf>) ==
    ...
    #
    # == Possible configuration platforms (full path is xmls/<*.xml>) ==
